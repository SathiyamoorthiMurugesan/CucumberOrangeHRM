...
public class Generic {
	...
	public WebDriver launchApplication1() throws Exception {
		...
		if (browserName.equalsIgnoreCase("chrome")) {
			System.setProperty("webgetDriver().chrome.driver", ".\\src\\main\\resources\\drivers\\chromedriver_128.exe");
...
//	Frame Related methods
	...
	public int noOfiFramesInWebPage() {
		int noOfiFramesdriver = getDriver().findElements(By.tagName("iframe")).size();
		return noOfiFramesdriver;
	}

	public int noOfFramesInWebPage() {
		int noOfiFramesdriver = getDriver().findElements(By.tagName("frame")).size();
		return noOfiFramesdriver;
	}
...
//	wait methods 
	...
	public void waitForElementToBeVisible(WebElement ele, int seconds) {
		try {
